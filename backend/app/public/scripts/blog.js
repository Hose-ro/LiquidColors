...
function createFallbackFeed() {
  ...
  return {
    posts: [
      {
        id: "demo-post-1",
        title: "Como preparar tus archivos para sublimacion sin perder color",
        excerpt: "Una guia corta para exportar PNG, cuidar margenes y evitar errores al imprimir.",
        content:
          "Antes de enviar un diseno revisa resolucion, area segura y fondo transparente.\n\nUsa PNG a buena escala, convierte textos importantes en curvas cuando aplique y deja margen de respiro para evitar cortes visuales.\n\nSi tienes dudas sobre formato, solicita una revision previa desde el formulario de personalizacion.",
        created_at: isoForOffset(0),
        tag: "Guia"
      },
      {
        id: "demo-post-2",
        title: "Tazas, camisetas y fundas: que producto conviene segun tu objetivo",
        excerpt: "Comparamos formatos de alta rotacion para promociones, regalos y branding de volumen.",
        content:
          "Las tazas funcionan muy bien cuando buscas recordacion diaria.\n\nLas camisetas ofrecen mas visibilidad para marcas o eventos.\n\nLas fundas y accesorios resuelven pedidos pequenos con mejor margen cuando el publico ya conoce la marca.",
        created_at: isoForOffset(-1),
        tag: "Articulo"
      },
      {
        id: "demo-post-3",
        title: "Errores comunes al pedir sublimacion y como evitarlos",
        excerpt: "Color, tamanos, cantidad minima y tiempos: lo que mas retrasa una entrega bien hecha.",
        content:
          "Los errores mas comunes aparecen cuando el arte final no coincide con el tamano real del producto.\n\nTambien conviene definir bien cantidades, fecha objetivo y metodo de envio antes de confirmar el pedido.\n\nUna especificacion clara reduce correcciones y mejora el resultado final.",
        created_at: isoForOffset(-3),
        tag: "Guia"
      },
      {
        id: "demo-post-4",
        title: "Como usar el blog para seguir novedades, entregas y avisos importantes",
        excerpt: "El feed publico ahora separa mejor contenido editorial, avisos y reportes semanales.",
        content:
          "El modulo del blog se actualiza para que la lectura sea mas clara.\n\nPuedes buscar publicaciones, filtrar por fecha y abrir cada articulo en una vista completa sin salir del feed.\n\nCuando el backend no esta disponible, el sitio muestra una vista demo para que la pagina no quede vacia.",
    ...
    deliveries: [
      ...
      },
      {
        ...
        summary: "Se completaron tazas y fundas de baja escala con salida estandar y express.",
        quantity: 11,
        range: "07 abr - 13 abr",
...
async function loadFeed({ silent = false } = {}) {
  ...
  try {
    ...
    setFeedStatus("Vista demo: feed no disponible", "warning");

    if (!silent) {
      toast("No se pudo conectar con el feed. Se muestra una vista demo.");
    }
  } finally {
    updateSummary();
    renderAvisos();
